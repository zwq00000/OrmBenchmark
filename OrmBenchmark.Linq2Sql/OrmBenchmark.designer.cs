...
namespace OrmBenchmark.Linq2Sql
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="D:\\GITHUB\\CS\\ORM\\ORMBENCHMARK\\ORMBENCHMARK.CONSOLE\\BIN\\DEBUG\\ORMBENCHMARK.MDF")]
	public partial class OrmBenchmarkDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeletePosts(Posts instance);
		...
		public OrmBenchmarkDataContext() : 
				base(global::OrmBenchmark.Linq2Sql.Properties.Settings.Default.D__GITHUB_CS_ORM_ORMBENCHMARK_ORMBENCHMARK_CONSOLE_BIN_DEBUG_ORMBENCHMARK_MDFConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public OrmBenchmarkDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public OrmBenchmarkDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public OrmBenchmarkDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
